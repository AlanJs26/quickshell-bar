...
Item { // Bar content region
    ...
    property real useShortenedForm: (screen?.width <= Appearance.sizes.barHellaShortenScreenWidthThreshold) ? 2 
                                    : (screen?.width <= Appearance.sizes.barShortenScreenWidthThreshold) ? 1 
                                    : 0
