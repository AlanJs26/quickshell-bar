    ...
    RowLayout {
        ...
        Loader {
            ...
            sourceComponent: CircleUtilButton {
                ...
                onClicked: Hyprland.dispatch("exec hyprshot --freeze --clipboard-only --mode region")
                altAction: () => Hyprland.dispatch("exec hyprshot --freeze --clipboard-only --mode window")
                MaterialSymbol {
