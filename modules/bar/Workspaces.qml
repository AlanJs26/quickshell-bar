            ...
            Button {
                ...
                background: Item {
                    ...
                    StyledText { // Workspace number text
                        opacity: root.showNumbers && isWorkspaceInMonitor(button.workspaceValue)
                    ...
                    Rectangle { // Dot instead of ws number
                        ...
                        opacity: (Config.options?.bar.workspaces.alwaysShowNumbers
                            || root.showNumbers && isWorkspaceInMonitor(button.workspaceValue)
                        ...
                        visible: opacity > 0
                        anchors.centerIn: parent
                        width: isWorkspaceInMonitor(button.workspaceValue) ? workspaceButtonWidth * 0.18 : workspaceButtonWidth * 0.18 / 2
                        height: width
                        radius: width / 2
                        color: (monitor?.activeWorkspace?.id == button.workspaceValue) ? 
                            Appearance.m3colors.m3onPrimary : 
